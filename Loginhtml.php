...
<body>
    ...
    <form class="form" action="Login.php" method="post">
        <div class="message">
            <h1 style="margin-top:20px;"><?php echo $message; ?></h1>
        </div>
        ...
        <br>
        <div class="btn">
            <button class="button" name="button" value="Registracja" type="submit">Registracja</button>
            <button class="button" name="button" value="Login" type="submit">Login</button>
        </div>
        <br>
    </form>
